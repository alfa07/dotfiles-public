...
use `~/Library/Application Support/nushell/nupm/modules/nupm/`
# use `~/Library/Application Support/nushell/nupm/modules/nu-themes/solarized-light.nu`
# use nu-themes/solarized-light.nu
...
let light_theme = {
    ...
    empty: "#268bd2"
    bool: {|| if $in { "#2aa198" } else { "dark_gray" } }
    int: "#586e75"
    filesize: {|e|
        if $e == 0b {
            "#586e75"
